...
public class Part1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("-");
    int age = 21; // equal operator means
    double height = 6.04;
    String myName = "Fernando Ramirez";
    final String BIRTH_DATE = "05/20/1997"; // final means constant (never changes)
    ...
    boolean fernandoIsMale = true; // using boolean
    if (fernandoIsMale == true) // if
      System.out.println("Fernando is indeed a male!");
    else // else
      System.out.println("Fernando is not male");

    System.out.println("-");

    String result; // the ternary operator will asign a value
    System.out.println(result = (fernandoIsMale == false) ? "Fernando is indeed a male! (ternary)" // conditional
                                                                                                   // operator
                                                                                                   // '?'
        : "Fernando is not male (ternary)"); // ternary condition
  ...
  /**
   * method that calls just the output, void.
   */
