...
public class Part2 {
  ...
  public static void main(String[] args) {
    ...
    AnotherClass myNameFernando = new AnotherClass(firstName, lastName); // instantiate
    System.out.println(myNameFernando.getFirstName() + " from getter getFirstName().");
    System.out.println(myNameFernando.getLastName() + " from getter getLastName().");
    myNameFernando.printName();
    System.out.println(" from calling the void method printName() \n");


    firstName = "Papi";
    AnotherClass myNamePapi = new AnotherClass(firstName); // calling overloaded
                                                           // constructor
    ...
    AnotherClass myNameNull = new AnotherClass();
